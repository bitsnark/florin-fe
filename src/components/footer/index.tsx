...
export function Footer() {
  return (
    <div className="w-full mt-auto border-t border-[#3A3740]">
      <div className="w-full flex flex-col md:flex-row h-auto md:h-[264px] px-4 py-5 md:pt-5 md:pr-64 md:pb-5 md:pl-5 justify-between">
